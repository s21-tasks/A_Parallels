...
class AntColony20 : public AntColony<T> {
    ...
    public:
        AntColony20(const Matrix<T> &graph, int threads = 4, double alpha = 0.8, double beta = 1.2,
    ...
    private:
        ...
        void AntsRun() override {
            ...
            // thm_.SetLoopFunction(AntColony<T>::ants_.size(), std::bind(&AntColony20<T>::ThreadFunc, this, std::placeholders::_1));
            thm_.Run();
